...
-- Original: /Users/alviniomolina/Documents/GitHub/just-daily-ops-platform/scripts/sql/fix-and-add-credentials.sql

-- COMPLETE FIX FOR API_CREDENTIALS TABLE
...
-- Step 4: Insert Eitje credentials (replace with your real values)
...
-- Step 5: Verify the credentials were inserted
SELECT 
    id,
    provider,
    base_url,
