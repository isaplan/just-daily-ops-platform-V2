...
export function getDocFiles(): DocFile[] {
  return [
    ...
    { path: "docs/business-rules.md", title: "Business Rules", route: "/docs/business-rules" },
...
export function getCurrentDoc(pathname: string, docFiles: DocFile[]): DocFile {
  ...
  // Handle /docs/business-rules route
  if (pathname === "/docs/business-rules") {
    return docFiles.find((doc) => doc.route === "/docs/business-rules") || docFiles[0];
  }
