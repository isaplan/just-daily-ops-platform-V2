/**
 * Migration API Route: products → products_aggregated
 * 
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('[Migration] Starting products → products_aggregated migration...');
    ...
    return NextResponse.json({
      success: true,
      message: `Migration complete: ${migrated} products migrated`,
      migrated,
      errors,
    });
  } catch (error: any) {
