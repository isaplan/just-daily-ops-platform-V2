/**
 * Product Performance - Client Component
...
interface ProductPerformanceClientProps {
  initialData?: {
    productData?: any;
    locations?: any[];
  };
...
export function ProductPerformanceClient({ initialData }: ProductPerformanceClientProps) {
  const viewModel = useProductPerformanceViewModel(initialData);
