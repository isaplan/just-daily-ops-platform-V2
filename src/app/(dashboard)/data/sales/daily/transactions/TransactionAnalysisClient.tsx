/**
 * Transaction Analysis - Client Component
...
export function TransactionAnalysisClient({ initialData }: TransactionAnalysisClientProps) {
  const viewModel = useTransactionAnalysisViewModel(initialData);
