/**
 * Time-Based Analysis - Client Component
...
interface TimeBasedAnalysisClientProps {
  initialData?: {
    timeData?: any;
    locations?: any[];
  };
...
export function TimeBasedAnalysisClient({ initialData }: TimeBasedAnalysisClientProps) {
  const viewModel = useTimeBasedAnalysisViewModel(initialData);
