/**
 * Table Analysis - Client Component
...
interface TableAnalysisClientProps {
  initialData?: {
    tableData?: any;
    locations?: any[];
  };
...
export function TableAnalysisClient({ initialData }: TableAnalysisClientProps) {
  const viewModel = useTableAnalysisViewModel(initialData);
