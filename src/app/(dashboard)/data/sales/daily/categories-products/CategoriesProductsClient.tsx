...
export function CategoriesProductsClient({ initialData }: CategoriesProductsClientProps) {
  ...
  const filterLabels = useMemo(() => [
    ...
    { key: "product", label: "Product", value: viewModel.selectedProduct !== "all" ? viewModel.selectedProduct : null },
    { key: "timePeriod", label: "Time Period", value: viewModel.activeTimePeriod },
  ], [
  ...
  const handleFilterChange = useCallback((key: string, value: any) => {
    switch (key) {
      ...
      case "product": viewModel.setSelectedProduct(value); break;
      case "timePeriod": viewModel.setActiveTimePeriod(value as "daily" | "weekly" | "monthly"); break;
    }
  }, [
  ...
  const handleFilterRemove = useCallback((key: string) => {
    switch (key) {
      ...
      case "product": viewModel.setSelectedProduct("all"); break;
      case "timePeriod": viewModel.setActiveTimePeriod("daily"); break;
    }
  }, [
    viewModel.setSelectedYear,
    viewModel.setSelectedMonth,
