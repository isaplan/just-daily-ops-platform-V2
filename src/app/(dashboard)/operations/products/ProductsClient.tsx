...
export function ProductsClient({ initialData }: ProductsClientProps) {
  ...
  const filteredCategories = useMemo(() => {
    ...
    return categories;
  }, [allCategories, groupedCategories, selectedMainCategory, selectedSubCategory, selectedMenu, searchQuery, menus, selectedWorkloadLevel, selectedMEPLevel]);
                      ...
                      <div className="space-y-2">
                        ...
                        {category.products.map((product) => (
                          <div key={product.productName} className="grid grid-cols-12 gap-4 items-center py-2 hover:bg-gray-50">
                            ...
                            <div className="col-span-2">
                              <Select
                                value={product.courseType || "none"}
                                onValueChange={(val) => {
                                  handleUpdateCourseType(product.productName, val === "none" ? null : val as CourseType);
                                }}
                              >
                                <SelectTrigger className="h-8">
