/**
 * Sales Bork ViewModel Layer
 * Business logic for Bork Sales Data page
 */
...
import {
  ...
  fetchEnvironmentIds,
  fetchSalesData,
} from "@/lib/services/data/sales-bork.service";
import { LocationOption, SalesRecord } from "@/models/data/sales-bork.model";

const ITEMS_PER_PAGE = 50;

export function useSalesBorkViewModel() {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: () => fetchSalesData(queryFilters),
